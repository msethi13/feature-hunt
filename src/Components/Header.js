...
function Header({setQuery}) {
  ...
  const inputPlaceholder =
    location.pathname === '/' ? 'Discover Projects...' : 'Search Features...';
  const search = (event) => {
    if (event.key === 'Enter') {
    ...
    <div className="header_div">
      <div className="header_container">
        <header className="header">
          <div className="nav">
            ...
            <div className="links">
              <ul data-testid="header_links">
                {loggedin && (
                  <li data-testid="header_sub" onClick={goTo('submit-project')}>
                    Submit Project
                  </li>
                )}
                ...
                {loggedin && (
                  <li data-testid="header_dash" onClick={goTo('dashboard')}>
                    Your Projects
                  </li>
                )}
              </ul>
          ...
          {!loggedin && (
            <div className="auth_button" data-testid="login_header">
