...
describe('SignUp tests', () => {
  it('renders signup', () => {
    ...
    history.push('/:id');
    const {getByTestId, getByText, queryByText, queryByTestId, getByRole} =
      render(
    ...
    const signtext = getByText(
      /Enter your name, email and password to get started with Feature Hunt!/i
    );
